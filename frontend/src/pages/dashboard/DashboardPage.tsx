                                    ...
                                    {addingBoardTo === project.id ? (
                                        <div className={styles.inlineForm}>
                                            <input
                                                ...
                                                onKeyDown={(e) => e.key === 'Enter' && handleAddBoard(project.id)}
                                                placeholder="New board name"
                                                className={styles.inlineInput}
                                            />
                                            <div className={styles.inlineActions}>
                                                <button onClick={() => handleAddBoard(project.id)} className={styles.addBtn}>Add</button>
                                                <button onClick={() => setAddingBoardTo(null)} className={styles.cancelBtn}>x</button>
                                            </div>
                                        </div>
                                    ) : (
                                        <button onClick={() => setAddingBoardTo(project.id)} className={styles.addBoardTrigger}>
                                            + Add Board
                                        </button>
                                    )}
